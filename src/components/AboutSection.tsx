...
const contactInfo = [
  { icon: Mail, label: "Email", value: "heedev94@gmail.com", href: "mailto:heedev94@gmail.com" },
...
const AboutSection = () => {
  return (
    <section id="about" className="h-full flex items-center py-16">
      {/* <div className="container mx-auto px-6 grid gap-10"> */}
      <div className="container px-6 grid gap-12 h-900:gap-6">
        ...
        <div className="max-w-4xl mx-auto">
          <article className="card-gradient border border-border rounded-2xl p-8 md:p-12 h-900:p-8 grid gap-10 h-900:gap-5">
            <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
              ...
              <div className="min-w-0 h-full flex flex-col gap-3 justify-center shrink-0">
                    ...
                    {contactInfo.map((item) => (
                      <li key={item.label} className="list-none">
                        <a
                          ...
                          className="flex flex-col items-center p-4 h-900:p-4 rounded-xl bg-secondary/50 hover:bg-secondary hover:border-primary/50 border border-transparent transition-all group"
                        >
